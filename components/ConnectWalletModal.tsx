...
const ConnectWalletModal: FC = () => {
  return (
    <Dialog.Root>
      <Dialog.Trigger className="btn-primary-fill w-[222px]">
        Connect Wallet
      </Dialog.Trigger>
      <Dialog.Portal>
        <Dialog.Overlay>
          <Dialog.Content className="fixed inset-0 bg-[#000000b6]">
            <div className="fixed top-1/2 left-1/2 w-[460px] -translate-x-1/2 -translate-y-1/2 transform rounded-2xl bg-white py-11 shadow-xl ">
              <div className="mx-12 mb-4 flex items-center justify-between">
                <Dialog.Title className="reservoir-h4 ">
                  Connect Wallet
                </Dialog.Title>
              ...
              <div className="reservoir-body-2 my-8 mx-12 ">
  ...
  return (
    <div className="grid">
      {connectors.map((connector) => (
        <button
          className="rounded-2xl py-4 hover:bg-neutral-100  md:rounded-none"
        ...
        >
          <a
            ...
            className={`reservoir-h6 flex items-center justify-between py-2 px-12  ${
